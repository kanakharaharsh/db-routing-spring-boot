...
public class DataSourceConfig {
	...
	public DataSource dataSource() {
		...
		final DataSource primaryDataSource = buildDataSource("PrimaryHikariPool", "spring.primary.datasource");
		final DataSource replicaDataSource = buildDataSource("ReplicaHikariPool", "spring.replica.datasource");
	...
	private DataSource buildDataSource(String poolName, String dataSourcePrefix) {
		...
		//To make sure Replica DB executes SELECT query only
		if (dataSourcePrefix.equals("spring.replica.datasource")) {
